...
@Getter
@Setter
public class PPageResponseDTO<E> {
    ...
    public PPageResponseDTO(PPageRequestDTO pPageRequestDTO, List<E> dtoList, int total){
        if(total<=0){
            return;
        }
        this.page = pPageRequestDTO.getPage();
        this.size = pPageRequestDTO.getSize();
        this.total = total;
